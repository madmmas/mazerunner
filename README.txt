...
Installation:
To run the project it was assumed that you have already nodejs and npm installed in the system. If not then you need to install it in the system.
